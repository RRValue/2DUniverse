#ifndef _CONTROLLING_CONTROLLERCUTQUADRATICBEZIER_H_
#define _CONTROLLING_CONTROLLERCUTQUADRATICBEZIER_H_
...
#endif //_CONTROLLING_CONTROLLERCUTQUADRATICBEZIER_H_
